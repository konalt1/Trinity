...
При оверрайде героя не копировать слепо `Ability10–17`. Читать ванильный `AbilityTalentStart` и затирать все ванильные `special_bonus_*`. Иначе хвост ванили плюс заглушки дают краш `UpgradeName9`. Порядок — скилл `.agents/skills/remove-vanilla-talents`.
...
9. Таланты: скилл `remove-vanilla-talents` — ванильный `AbilityTalentStart`, ровно 8 заглушек `special_bonus_unique_custom_<hero>_1..8`, без хвоста ванильных `special_bonus_*`

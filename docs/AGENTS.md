...
- У Largo на спавне: `modifier_largo_mind_power` (серверный Mind Power override ванильного магического урона)
...
- Серверный override ванильного Largo: `modifier_largo_mind_power` в `Game/scripts/vscripts/abilities/largo/largo_childhood_memories.lua`
...
Герой включён в `Activelist.txt`. Q, W и ульт остаются ванильными. Врождёнка Encore вырезана: `largo_encore` выдаётся шардом в слот D с уже включённым ванильным эффектом шарда (`repeat_buff`).

| Слот | Способность | Статус |
|------|-------------|--------|
| Q | `largo_catchy_lick` | Ванильная — Липкий Лизь |
| W | `largo_frogstomp` | Ванильная — Жабий Топ |
...
Магический урон ванильных Q, W и Fight Song масштабируется Силой магии через `modifier_largo_mind_power` (серверный override специальных значений), без Lua-клонов этих способностей.

**Lua:** `abilities/largo/largo_childhood_memories.lua`

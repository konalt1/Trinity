...
require ("abilities/custom_fountain_aura")
require ("abilities/nevermore/nevermore_shadowraze_trinity")
require ("abilities/nevermore/nevermore_requiem_trinity")
...
require ("abilities/tinker/tinker_laser_custom")
require ("abilities/tinker/tinker_march_of_the_machines_custom")
require ("abilities/tinker/tinker_deploy_turrets_custom")
require ("abilities/tinker/tinker_rearm_custom")
require ("abilities/dawnbreaker/dawnbreaker_celestial_hammer_custom")
require ("abilities/dawnbreaker/dawnbreaker_luminosity_custom")
...
require ("items/item_desolator_2")
require ("items/item_shop_rework_inherit")
...
function Precache( context )
	...
	PrecacheResource("model", "models/props_consumables/high_five/mh_poogie/poogie_exclamation.vmdl", context)
	PrecacheResource("particle", "particles/econ/items/queen_of_pain/qop_2022_immortal/queen_2022_scream_of_pain_owner_wave_edge.vpcf", context)
	PrecacheResource("sound", "sounds/vo/primal_beast/primal_intro_02.vsnd", context)
...
function CAddonTemplateGameMode:InitGameMode()
	...
	pcall(function()
		GameRules:SetAllowNeutralItemDrops(false)
	end)
	pcall(function()
